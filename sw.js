const CACHE='cuaderno-ef-v3-8-1';
const ASSETS=['./','./index.html','./styles.css?v=3.8.1','./app.js?v=3.8.1','./manifest.webmanifest?v=3.8.1','./icons/icon-192-v381.png','./icons/icon-512-v381.png','./icons/apple-touch-icon-v381.png'];
