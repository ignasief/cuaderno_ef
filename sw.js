const CACHE='cuaderno-ef-v3-8-8';
const ASSETS=['./','./index.html','./styles.css?v=3.8.8','./app.js?v=3.8.8','./manifest.webmanifest?v=3.8.8','./icons/icon-192-v382.png','./icons/icon-512-v382.png','./icons/apple-touch-icon-v382.png'];
